...
for i_reg=1:7
    ...
    subplot(3,5,14);  hold on; box on; plot(x_t,pdf(probs(6),x_t),'linewidth',1.5);
    subplot(3,5,15); hold on; box on; plot(x_s,pdf(probs(7),x_s),'linewidth',1.5);
