...
for i_param=1:length(M0_space)
    ...
    fjord_run = prepare_boxmodel_input(datasets,fjords_processed(fjord_ids(id)),fjord_ids(id));
    ...
    save([outs_path,name_exp,'_MPhr.mat'],'fjord_run','-v7.3') % v7.3 allows files > 2GB; MPhr stands for the ocean forcing used    
end
