function [hf_t,hf_s] = plot_sensitivity_profiles_v2(X,ensemble,res_box,param_names,param_ranges,i_day,figs_path,i_yr)
...
hf_t{i_bnd} = figure('Name',sprintf('Temperature sensitivity %s',key_param_bnd{i_bnd}),'Position',[40 40 1200 400*length(param_names)]);
...
if nargin > 7
    exportgraphics(gcf,[figs_path,'sensitivity_profiles_datacomp_',key_param_bnd{i_bnd},'_',num2str(2015+i_yr),'_n',num2str(n_runs),'.png'],'Resolution',300)
end
end
