    ...
    for i_param=1:n_params
        ...
        for i_fjord=1:n_fjord_runs
            ...
            if i_param==1 && i_fjord==1
                h1 = scatter(x_var,best_fjord_params(i_fjord).best_t.(param_names{i_param}),250,lcolor(i_yr,:),'filled','^','MarkerFaceAlpha',.75);
                % h2 = scatter(x_var,best_fjord_params(i_fjord).best_s.(param_names{i_param}),150,lcolor(i_yr,:),'filled','v','MarkerFaceAlpha',.5);
            else
                scatter(x_var,best_fjord_params(i_fjord).best_t.(param_names{i_param}),250,lcolor(i_yr,:),'filled','^','MarkerFaceAlpha',.75);
...
legend(h_yr,lbl_years,'fontsize',fsize,'Location','Southwest');
