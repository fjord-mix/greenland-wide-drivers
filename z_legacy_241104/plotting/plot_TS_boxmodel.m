...
%% If we have observations to add to the plot...
if nargin == 3    
    [Xf,Yf]    = meshgrid(fjords_map.x,fjords_map.y); % get fjord limits to select obs data accordingly
